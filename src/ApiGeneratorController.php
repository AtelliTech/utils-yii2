...
{
    /**
     * @var string default: v1
     */
    public $name = 'v1';

    /**
     * @var string default: @vendor/atellitech/utils-yii2/src/templates/api.php.tmpl
     */
    public $template = '@vendor/atellitech/utils-yii2/src/templates/api.php.tmpl';

    /**
     * @var string default: @vendor/atellitech/utils/templates/module
     */
